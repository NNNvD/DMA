.PHONY: help install dev test lint format format-check typecheck ci phase1-check phase2-check phase3-check phase1-benchmark db-revision db-upgrade import-assets preview-assets
